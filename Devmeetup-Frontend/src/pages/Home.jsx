...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Discover Events Right Here</title>
        <meta name="description" content="The premier platform for creators and enthusiasts. Find trending events, experiences, and community gatherings nearby." />
        <meta property="og:title" content="Discover Events Right Here" />
        <meta property="og:image" content={speecialEvents[0]?.banner} />
      </Helmet>
      <div className="min-h-screen bg-white text-[#1d1d1f] font-['Satoshi'] antialiased overflow-x-hidden">
        ...
        <section className="max-w-5xl mx-auto py-16 md:py-24">
          ...
          <div className="flex justify-between items-end mb-10 px-6 md:px-0">
            ...
            <button className=" font-bold cursor-pointer text-blue leading-loose border-black pb-0.5"
              onClick={()=>navigate("/events")}
            >
              View all
            </button>
          ...
          <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto md:overflow-visible px-6 md:px-0 no-scrollbar snap-x snap-mandatory">
            ...
            {loading ? (
              [...Array(3)].map((_, i) => (
                ...
                >
                  <div className="aspect-4/5 rounded-3xl mb-4 overflow-hidden relative bg-neutral-200">
                ...
                featuredEvents.map((event, index) => (
                  ...
                  >
                    {/* CARD */}
                    <div className="relative aspect-4/5 rounded-3xl overflow-hidden mb-4 shadow-sm bg-neutral-100">
                      ...
                      <div className="absolute inset-0 bg-linear-to-t from-black/40 via-black/10 to-transparent opacity-70 group-hover:opacity-40 transition" />

                      {/* price badge */}
                      <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-md px-3 py-1 rounded-full text-[11px] font-semibold shadow-sm">
                        {event.is_free || event.is_free === 1 || event.is_free === "1"
                          ? "Free"
                          : `₦${event.price || 0}`}
                      </div>

                      {/* bottom text overlay (more premium feel) */}
                      <div className="absolute bottom-0 left-0 right-0 p-4">
                        ...
                        <h3 className="text-white text-lg font-semibold leading-snug group-hover:translate-y-0.5 transition">
                          {event.title}
                        </h3>
                      </div>
                    </div>
        ...
        <section className="max-w-5xl mx-auto mb-20 px-6 md:px-0">
          <div className="bg-[#1d1d1f] rounded-[2.5rem] md:rounded-[3rem] p-10 md:p-20 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <button className="w-full sm:w-auto px-10 py-4 bg-white text-black rounded-full font-medium active:scale-95 transition-all shadow-xl">
