...
export default function Authform() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-[Satoshi] bg-white">
      {" "}
      {/*Main container for the auth form, centered on the page  */}
      <div className="w-full max-w-md p-6">
        {" "}
        {/* Card container with max width and padding */}
        {/* Logo and title */}
        ...
        {mode === "forgot" && (
          <div>
            <button
              ...
              className="flex cursor-pointer items-center gap-2 hover:text-amber-400 text-sm mb-8 transition-colors text-neutral-600"
            >
              <svg
                width="16"
                height="16"
            ...
            {!forgotSent ? (
              <>
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full bg-amber-400 hover:bg-amber-300 text-black font-bold py-3 rounded-xl text-sm transition-all duration-200 mt-2"
                  >
                    Send reset link
                  </button>
                </form>
              ...
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="mt-6 text-sm text-amber-400 hover:text-amber-300 underline underline-offset-4 transition-colors"
                >
                  Back to sign in
                </button>
              </div>
          ...
          <>
            ...
            <form className="space-y-4" onSubmit={handleSignIn}>
              ...
              <div>
                <div className="flex justify-between mb-1.5">
                  <label className="text-xs text-neutral-400 font-medium tracking-wide uppercase">
                    Password
                  </label>
                  <button
                    type="button"
                    ...
                    className="text-xs text-amber-500 cursor-pointer hover:text-amber-400 transition-colors"
                  >
                    Forgot password?
                  </button>
                </div>
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute cursor-pointer right-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-amber-400 transition-colors"
                  >
                    {showPass ? (
                      <svg
                        width="18"
            ...
            <p className="text-center text-sm text-neutral-500 mt-6">
              ...
              <button
                ...
                className="text-amber-500 cursor-pointer hover:text-amber-400 font-semibold transition-colors"
              >
                Create one
              </button>
            </p>
          ...
          <>
            ...
            <form className="space-y-4" onSubmit={handleSignUp}>
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full cursor-pointer bg-amber-400 hover:bg-amber-300 text-black font-bold py-3 rounded-xl text-sm transition-all shadow-lg shadow-amber-400/20 mt-2 disabled:opacity-50"
              >
