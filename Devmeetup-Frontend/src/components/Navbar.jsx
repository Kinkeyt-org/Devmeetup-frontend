            ...
            {user ? (
              <>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-32 bg-white border border-neutral-200 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-50">
                    <button
                      onClick={handleLogout}
                      className="w-full text-left px-4 py-2 text-sm hover:bg-neutral-100 rounded-lg"
                    >
                      Logout
                    </button>
                  </div>
