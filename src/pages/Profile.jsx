    ...
    <div className="min-h-screen bg-transparent text-neutral-900 dark:text-neutral-100 font-sans pb-24 selection:bg-neutral-200 dark:selection:bg-neutral-800">
      ...
      <main className="max-w-2xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col items-center mt-8 mb-10">
          ...
          <h1 className="mt-5 text-2xl md:text-3xl font-bold tracking-tight text-neutral-900 dark:text-white text-center">
            {user.name}
          </h1>
        ...
        {/* ACCOUNT SETTINGS */}
        <h2 className="text-[13px] font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-widest mb-3 px-4">
          Account Settings
        </h2>
